...
var file_api_api_test_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xfb, 0x01, 0x0a, 0x0b, 0x54,
	...
	0x69, 0x61, 0x6b, 0x46, 0x65, 0x74, 0x63, 0x68, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x65, 0x74, 0x65,
...
var file_api_api_test_proto_goTypes = []interface{}{
	...
	(*RiakStoreResp)(nil), // 4: api.RiakStoreResp
	(*RiakFetchResp)(nil), // 5: api.RiakFetchResp
}
var file_api_api_test_proto_depIdxs = []int32{
	...
	3, // 3: api.TestService.Hello:output_type -> api.HelloResp
	4, // 4: api.TestService.TestRiakStore:output_type -> api.RiakStoreResp
	5, // 5: api.TestService.TestRiakFetch:output_type -> api.RiakFetchResp
